...
A configuration that is currently heavily in use is the \gls{cdn} configuration. In
...
\begin{figure}
    ...
    \caption{The \gls{cdn} configuration}\label{fig:cdn}
\end{figure}
...
\gls{cdn} configuration. When the proxy server receives a request for a segment,
...
configuration and the \gls{cdn} configuration is that there is no caching involved.
