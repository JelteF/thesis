...
natural difference when being able to server from cache. Two other options for
...
known server setup for streaming video is by using a \cdn. This thesis looked
into the possibility of using the proxy servers deployed in a \cdn, not only for
serving static content, but on the fly conversion of videos.
