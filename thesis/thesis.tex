...
\expandafter\newcommand\csname #1full\endcsname{\acrfull{#1}\xspace}
}
...
in the chapter \nameref{ch:problem}. The new setups consist of the two flavors,
...
% TODO move this shit to results as well
...
\begin{appendices}
    ...
    of space.
    \VerbatimInput[fontsize=\footnotesize]{log.txt}
\end{appendices}
