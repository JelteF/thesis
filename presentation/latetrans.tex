\begin{tikzpicture}[ ]
    ...
    \nodewithdesc{sp}{below=2cm of cl}{right=7cm of}{Segment proxy}{Caches segment}{3}{10}

    \nodewithdesc{ismp}{below right=1cm and 3cm of sp}{right=1.768cm
    of}{IsmProxyPass}{Creates segment from range requests}{5}{9}
    \nodewithdesc{rp}{below left=1cm and 3cm of ismp}{right=7cm of}{Range request
    proxy}{Caches byte range responses}{6}{8}

    \nodewithdesc{ap}{below=3cm of rp}{right=3cm of}{Apache}{Returns the
    requested bytes of the mp4}{7}{7};
    ...
    \contwithlabel{ap}{storage}{Storage server}{-0.3,0.6}{2,-0.6}{6}
